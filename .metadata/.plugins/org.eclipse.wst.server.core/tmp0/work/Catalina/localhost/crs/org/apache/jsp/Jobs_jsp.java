 ...
 * Generated at: 2021-10-21 17:38:42 UTC
...
public final class Jobs_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(session.getAttribute("login_level") == null) { 
	...
	ArrayList allJob = jobDetails.getAllJob(company_id);
      ...
      out.write("          <!-- ################################################################################################ -->\r\n");
      out.write("          <h2>Search Job By Companies</h2>\r\n");
 ...
 for(int i=0;i<allJob.size();i++) 
      ...
      out.write("              <div class=\"imgl borderedbox\"><a href=\"JobsDetails.jsp?job_id=");
      out.print(JobDetails.get("job_id"));
      out.write("\"><img src=\"companyImages/");
 out.print(JobDetails.get("company_image")); 
      out.write("\" style=\"height:80px; width:80px;\"></a></div>\r\n");
      out.write("              <p class=\"nospace btmspace-15\"><a href=\"JobsDetails.jsp?job_id=");
      out.print(JobDetails.get("job_id"));
      out.write('"');
      out.write('>');
      out.print(JobDetails.get("job_title"));
      out.write("</a></p>\r\n");
      out.write("              <p>");
      out.print(JobDetails.get("company_description"));
      out.write("</p>\r\n");
      out.write("            </li>\r\n");
      out.write("           ");
