        ...
        <div class="one_half" style="width:68%"> 
		  ...
		  %>
            <li class="clear" style="padding:1px 1px; margin:1px 1px">
              <div class="imgl borderedbox"><a href="JobsDetails.jsp?job_id=<%=JobDetails.get("job_id")%>"><img src="companyImages/<% out.print(JobDetails.get("company_image")); %>" style="height:80px; width:80px;"></a></div>
              <p class="nospace btmspace-15"><a href="JobsDetails.jsp?job_id=<%=JobDetails.get("job_id")%>"><%=JobDetails.get("job_title")%></a></p>
