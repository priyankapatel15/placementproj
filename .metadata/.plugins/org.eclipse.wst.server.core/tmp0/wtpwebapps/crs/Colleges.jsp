        ...
        <div class="one_half" style="width:68%"> 
		  ...
		  %>
            <li class="clear" style="padding:1px 1px; margin:1px 1px">
              <div class="imgl borderedbox"><a href="CollegeDetails.jsp?college_id=<%=CollegeDetails.get("college_id")%>"><img src="collegeImages/<% out.print(CollegeDetails.get("college_image")); %>" style="height:80px; width:80px;"></a></div>
              <p class="nospace btmspace-15"><a href="CollegeDetails.jsp?college_id=<%=CollegeDetails.get("college_id")%>"><%=CollegeDetails.get("college_name")%></a></p>
